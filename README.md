...
| 🛠️ **Action**              | Reusable automation logic              | `actions/checkout`                   |
| 🖥️ **Runner**              | Machine that executes jobs             | GitHub-hosted or self-hosted         |
| ☁️ **GitHub-hosted Runner** | Runner provided by GitHub              | `ubuntu-latest`                      |
...
| 🏷️ **name**                | Human-readable label                   | Workflow or job name                 |
...
| 🛡️ **permissions**         | GitHub token access control            | Least privilege                      |
| 📥 **checkout**             | Fetch repository code                  | `actions/checkout`                   |
| ⚡ **cache**                 | Store reusable data                    | Faster builds                        |
| 📦 **artifacts**            | Files saved after workflow             | Logs, binaries                       |
| ⬆️ **upload-artifact**      | Save files                             | Share between jobs                   |
| ⬇️ **download-artifact**    | Retrieve saved files                   | Next job use                         |
...
| 🔑 **OIDC**                 | Secure auth without secrets            | “Secure login without passwords”     |
| ♻️ **Reusable Workflow**    | Workflow called by another             | DRY principle                        |
| 🧱 **Composite Action**     | Multiple steps as one action           | Custom action                        |
| 🏪 **Marketplace**          | Public actions repository              | GitHub Marketplace                   |
